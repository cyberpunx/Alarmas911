...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'nombre_tipo_servicio',array('size'=>1,'maxlength'=>1)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'observaciones_tipo_servicio'); ?>
		<?php echo $form->textField($model,'observaciones_tipo_servicio',array('size'=>1,'maxlength'=>1)); ?>
	</div>
