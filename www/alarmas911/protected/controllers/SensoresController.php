...
class SensoresController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Sensores');
	...
	{
		$model=new Sensores('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Sensores']))
			$model->attributes=$_GET['Sensores'];
	 ...
	 * @return Sensores the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Sensores::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Sensores $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sensores-form')
		{
