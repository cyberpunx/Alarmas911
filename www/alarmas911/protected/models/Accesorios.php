...
class Accesorios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('modelos_modelo_id, baterias_bateria_id, sistema_alarmas_sistema_alarma_id', 'length', 'max'=>11),
			array('nombre_accesorio', 'length', 'max'=>128),
			array('observaciones_accesorio', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('accesorio_id, modelos_modelo_id, baterias_bateria_id, sistema_alarmas_sistema_alarma_id, nombre_accesorio, observaciones_accesorio', 'safe', 'on'=>'search'),
		);
	}
