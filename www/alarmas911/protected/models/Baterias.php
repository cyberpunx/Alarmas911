...
class Baterias extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Sistema_Alarmas_sistema_alarma_id, Modelos_id_modelo, Tipos_Baterias_tipo_bateria_id', 'required'),
			array('Sistema_Alarmas_sistema_alarma_id, Modelos_id_modelo, Tipos_Baterias_tipo_bateria_id, vida_util', 'length', 'max'=>11),
			array('observaciones_bateria', 'length', 'max'=>1),
			array('fecha_alta, fecha_baja', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('bateria_id, Sistema_Alarmas_sistema_alarma_id, Modelos_id_modelo, Tipos_Baterias_tipo_bateria_id, observaciones_bateria, vida_util, fecha_alta, fecha_baja', 'safe', 'on'=>'search'),
		);
	}
