...
--
-- Table structure for table `tipos_monitoreo`
--

DROP TABLE IF EXISTS `tipos_monitoreo`;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 PACK_KEYS=0 COMMENT='Tabla que representa los tipos de monitoreo que provee la empresa. ';
...
/*!40000 ALTER TABLE `tipos_monitoreo` DISABLE KEYS */;
INSERT INTO `tipos_monitoreo` VALUES (1,'Sin Monitoreo',NULL),(2,'Full Monitoreo',NULL);
/*!40000 ALTER TABLE `tipos_monitoreo` ENABLE KEYS */;
UNLOCK TABLES;
